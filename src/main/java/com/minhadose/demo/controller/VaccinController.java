...
public class VaccinController {
    ...
    public ResponseEntity<List<MandatoryVaccinDTO>> getMandatoryVaccins() {
        List<MandatoryVaccinDTO> mandatoryVaccins = vaccinService.getMandatoryVaccins();
        return ResponseEntity.ok(mandatoryVaccins);
    }
}